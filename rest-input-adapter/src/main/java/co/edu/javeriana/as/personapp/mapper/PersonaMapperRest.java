...
public class PersonaMapperRest {
	...
	public Person fromAdapterToDomain(PersonaRequest request) {
		return new Person(Integer.parseInt(request.getDni()), request.getFirstName(), request.getLastName(), Gender.valueOf(request.getSex()), Integer.parseInt(request.getAge()));
	}
